...
export default class Database {
  ...
  private static readonly DEFAULT_CONNECTION_URL: string =
    'postgres://localhost:5432/graphql_workshop';
  private static INSTANCE: Database;

  private constructor() {
    const url =
      process.env.DB_CONNECTION_URL ?? Database.DEFAULT_CONNECTION_URL;
